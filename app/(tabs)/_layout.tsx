...
const OPERATION_OPTIONS = [
  { id: 'loan', icon: 'user-dollar', labelKey: 'lendMoney', route: '/operations/loan' },
  { id: 'promissory_note', icon: 'receipt-2', labelKey: 'promissoryNotes', route: '/operations/promissory-note' },
  { id: 'rent_property', icon: 'home', labelKey: 'rentProperties', route: '/operations/rent-property' },
  { id: 'rent_room', icon: 'door-outline', labelKey: 'rentRooms', route: '/operations/rent-room' },
  { id: 'rent_vehicle', icon: 'car', labelKey: 'rentVehicles', route: '/operations/rent-vehicle' },
] as const;
